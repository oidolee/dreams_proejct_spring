                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-md-6">
                            ...
                            <div class="card bg-primary text-white mb-4" onclick="moveChange(1)">
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-warning text-white mb-4" onclick="moveChange(2)">
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-success text-white mb-4" onclick="moveChange(3)">
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-danger text-white mb-4" onclick="moveChange(4)">
