...
<body>
        ...
        <div class="stadium-content">
            ...
            <ul class="stadium-tab">
                <li><a class="menuLink" href="${path}/resources/page_6/stadium.jsp">고척 스카이돔</a></li>
                ...
                height: 50px;
                line-height: 50px;
                border-radius: 20px;"><a class="menuLink" href="${path}/resources/page_6/parking.jsp" style="color: #FFF !important">주차안내</a></li>
            </ul><br><br><br>
