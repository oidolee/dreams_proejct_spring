        ...
        <!-- 상단 중앙1 시작 -->
            ...
            <div style="width: 1000px;">
                <h2 align="center" style="color: #000 !important; margin-top: 20px;"> 안내 및 Q&A </h2><br>
                        ...
                        <label class="btn btn-outline-primary" for="btnradio4"><a href="qnaMd.jsp" style="color: white !important;">MD</a></label>
                    ...
                    <div class="accordion" id="accordionExample">
                        <div class="accordion-item">
                            ...
                            <div class="accordion-body">
                                드림즈 구단 상품은 온라인 샵과 오프라인 샵을 통해 판매됩니다.<br><br>

                                [온라인]<br>
                                홈페이지 상단 메뉴바의 GOODS를 통해 온라인 샵을 이용하실 수 있습니다.<br><br>

                                [오프라인]<br>
                                오프라인 샵은 경기장을 잘 찾아보시면 어딘가에 위치하고 있습니다.<br>
                                매장은 상시운영이 아닌 시즌 중 홈경기에 한해 운영되며,<br>
                                입장 시작시부터 경기 종료 직후까지 상품 구입이 가능합니다.<br><br>

                                매장 내 따로 전화번호는 없습니다.<br><br>

                                경기장도 잘 찾아보시면 어딘가에 있을 수도....<br>
