    ...
    <body>
        ...
        <div class="slider-con">
			<div class="slider-box">
				<img src="${path}/resources/image/banner/드림즈_포토샵.jpg">
			</div>
		</div>
			...
			<div id="contents">
                <div class="select_id1">
                    <div class="select_id2">
                        <h4 style="font-weight: bold; color: #333 !important; letter-spacing: -1px;">아이디 찾기</h4>
                    </div>
                    <div style="font-size: 14px; color: #000 !important; margin-top: 10px; letter-spacing: -1px;">
                        <td>아이디 찾는 방법을 선택해 주세요.</td>
                    </div>
                </div>
                <div class="select_9">
                    <div class="box6" style="margin-bottom: 80px;">
                        <!-- 휴대전화로 인증 -->
                                    ...
                                    <ul style="margin-bottom: 7px">
                                        ...
                                        <li>
                                            <div class="int_mod" style="margin: 0 5px 0 5px;">
                                                <input type="text" id="phoneNo" name="phoneNo" class="input_txt" placeholder="휴대전화번호" style=" color:#000 !important; font-size: 13px; width: 125.4px;">
                                            </div>
                                        </li>
                                        <li>
                                            <input type="button" id="certify" name="certify" value="인증번호 받기" style="letter-spacing: -1px; font-weight: bold; font-size: 13.5px; width: 98px; color: #000 !important;">
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
                                            <input type="text" id="phoneNq" name="phoneNq" maxlength="40" class="input_txt" placeholder="인증번호 6자리 숫자 입력" style="letter-spacing: -1px; margin-left: 78px; width: 202px; font-size: 13px; background: #f7f7f7; border: 1px solid; height: 22px;">
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div id="div_email" class="box_selected2" style="margin-top: 30px; margin-bottom: 25px;">
                            <input type="radio" id="r_pn2" class="input_rd" name="authenticationMethod">
                            <label for="r_pn2" class="label_rd" style="color: #333 !important">본인확인 이메일로 인증</label>
                            <!-- 이메일로 인증 내용 -->
                            <div class="box_sub" id="emailAuthentication" style="display: none;">
                                <p class="dsc" style="letter-spacing: -1px; color: #666 !important">본인 확인 이메일 주소와 입력한 이메일 주소가 같아야, 인증번호를 받을 수 있습니다.</p>
                                <div>
                                    <ul>
                                        <li style="margin-bottom: -9px">
                                            <label for="phoneNm" class="label_txt" style="color: #333 !important; padding-right: 50px; font-weight: 700 !important">이름</label>
                                ...
                                <div class="phoneInfo" >
                                    <ul style="margin-bottom: 7px">
                                        <li>
                                            <label for="t_ph1" class="label_txt" style= "color: #333 !important; padding-right: 2px; font-weight: 700 !important">이메일 주소</label>
                                        </li>
                                        <li>
                                            <div class="int_mod" style="margin: 0 5px 0 5px;">
                                                <input type="text" id="phoneNo" name="phoneNo" class="input_txt" style=" color:#000 !important; font-size: 13px; width: 202px;">
                                            </div>
                                        </li>
                                        <li>
                                            <input type="button" id="certify" name="certify" value="인증번호 받기" style="letter-spacing: -1px; font-weight: bold; font-size: 13.5px; width: 98px; color: #000 !important;">
        ...
        <section class="section-1-con">
            <div class="section-1 center">
                ...
                <div class="section-1-bottom">
                    <ul>
                        <li><a href="${path}/WEB-INF/views/page_2/ticketFee.jsp"><img src="${path}/resources/image/main/dreams_char.png"
                                    alt=""></a></li>
                        <li><a href="https://www.instagram.com/explore/tags/%EC%8A%A4%ED%86%A0%EB%B8%8C%EB%A6%AC%EA%B7%B8/top/"><img src="https://www.heroesbaseball.co.kr/html/front/web_2018/images/index/btn_link_toolbar_item2.png"
                                    alt=""></a></li>
                        <li><a href="${path}/WEB-INF/views/page_6/stadium.jsp"><img src="https://www.heroesbaseball.co.kr/html/front/web_2018/images/index/btn_link_toolbar_item3.png"
                                    alt=""></a></li>
                    </ul>
                </div>
            </div>
