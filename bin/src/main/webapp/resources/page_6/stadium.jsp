...
<body>
        ...
        <div id="slider_con" class="slider-con">
            <img src="${path}/resources/image/banner/category_DREAMS.jpg">
        </div>
        <br>
        ...
        <div class="stadium-content">
            ...
            <ul class="stadium-tab">
                <li style="
                    ...
                    height: 50px;
                    line-height: 50px;
                    border-radius: 20px;"><a class="menuLink" href="${path}/resources/page_6/stadium.jsp" style="color: #FFF !important">고척 스카이돔</a></li>
                <li><a class="menuLink" href="${path}/resources/page_6/amenity.jsp">편의시설</a></li>
                <li><a class="menuLink" href="${path}/resources/page_6/location.jsp">찾아오시는 길</a></li>
                <li><a class="menuLink" href="${path}/resources/page_6/parking.jsp">주차안내</a></li>
            </ul><br>
        </div>
        <br>
        <br>
